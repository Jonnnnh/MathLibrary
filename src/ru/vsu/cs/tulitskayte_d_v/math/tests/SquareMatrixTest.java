...
import ru.vsu.cs.tulitskayte_d_v.math.matrix.Matrix4;
...
public class SquareMatrixTest {
    ...
    void testSumMatrix() {
        ...
        //for 3matrix
        MathExceptions thrown = assertThrows(MathExceptions.class, () -> {
            float[][] matrix3Input = new float[][]{
                    {1, 2, 3},
                    {4, 5, 6},
                    {3, 4, 5}
            };
            Matrix m3 = new Matrix3(matrix3Input);
            ...
            Matrix m4 = new Matrix4(matrix4Input);

            m3.sumMatrix(m3, m4);
        });
        assertEquals("Error in values!", thrown.getMessage());

        //for 4matrix
        thrown = assertThrows(MathExceptions.class, () -> {
            float[][] matrix3Input = new float[][]{
                    {1, 2, 3},
                    {4, 5, 6},
                    {3, 4, 5}
        ...
        Matrix matrix1 = new Matrix3(m1);
        Matrix matrix2 = new Matrix3(m2);
        ...
        matrix1 = new Matrix4(m1);
        matrix2 = new Matrix4(m2);
